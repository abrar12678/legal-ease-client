...
export default function SignInPage() {
  ...
  useEffect(() => {
    document.title = "Login | LegalEase";
  }, []);
    ...
    <div className="min-h-screen bg-gray-50 flex items-center justify-center px-4 py-10">
      ...
      >
        ...
        <div className="text-center mb-8">
          ...
          <h1 className="text-2xl font-bold text-[#1B2A4A]">Welcome Back</h1>
        ...
        <div className="bg-white rounded-2xl border border-gray-100 shadow-sm p-6 sm:p-8">
          <form onSubmit={onSubmit} className="flex flex-col gap-4">
            ...
            <button
              type="submit"
              disabled={loading}
              className="w-full flex items-center justify-center gap-2 bg-[#1B2A4A] hover:bg-[#243A5E] text-white font-semibold py-3 rounded-xl transition-all duration-200 disabled:opacity-50 disabled:cursor-not-allowed"
            >
              {loading ? (
                <svg
